...
O dashboard construído está disponível em [https://evidence.camarim.cloud/](https://evidence.camarim.cloud/) e, caso tenham interesse, posso fazer um novo artigo explicando mais detalhadamente o funcionamento do framework e como está sendo feita a consulta dos dados do Well-Architected.
